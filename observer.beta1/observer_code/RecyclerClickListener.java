...
public abstract class RecyclerClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        if (gestureDetector.onTouchEvent(e)) {
            ...
            if (clickedChild != null && clickedChild.dispatchTouchEvent(e)) {  //по умолчанию было if (clickedChild != null && !clickedChild.dispatchTouchEvent(e)) {  ---- т.е. стал перехват везде
